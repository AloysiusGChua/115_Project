...
import com.ust.project.siklab.Quizzes.ActivityQuizFive;
import com.ust.project.siklab.Quizzes.ActivityQuizFour;
import com.ust.project.siklab.Quizzes.ActivityQuizOne;
import com.ust.project.siklab.Quizzes.ActivityQuizThree;
import com.ust.project.siklab.Quizzes.ActivityQuizTwo;
        ...
        quizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (lessonNum) {
                    ...
                    case 2 :
                        intent = new Intent(getApplicationContext(), ActivityQuizTwo.class);
                        intent.putExtra("LESSON_NUMBER", lessonNum);
                        intent.putExtra("QUIZ_NUMBER", 1);
                    ...
                    case 3 :
                        intent = new Intent(getApplicationContext(), ActivityQuizThree.class);
                        intent.putExtra("LESSON_NUMBER", lessonNum);
                        intent.putExtra("QUIZ_NUMBER", 1);
                    ...
                    case 4 :
                        intent = new Intent(getApplicationContext(), ActivityQuizFour.class);
                        intent.putExtra("LESSON_NUMBER", lessonNum);
                        intent.putExtra("QUIZ_NUMBER", 1);
                    ...
                    case 5 :
                        intent = new Intent(getApplicationContext(), ActivityQuizFive.class);
                        intent.putExtra("LESSON_NUMBER", lessonNum);
                        intent.putExtra("QUIZ_NUMBER", 1);
