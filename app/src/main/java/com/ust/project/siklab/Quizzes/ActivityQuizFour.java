...
import com.ust.project.siklab.Results.ActivityResultFour;
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quizNum < 5) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), ActivityQuizFour.class);
                    ...
                    startActivity(new Intent(getApplicationContext(), ActivityResultFour.class));
                }
            }
        });
    }
