...
import com.ust.project.siklab.Results.ActivityResultThree;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quizNum < 5) {
                    db.updateAnswer(lessonNum, quizNum, selectedAnswer);

                    Intent intent = new Intent(getApplicationContext(), ActivityQuizThree.class);
                    ...
                    startActivity(new Intent(getApplicationContext(), ActivityResultThree.class));
                }
            }
        });
    }
