...
import com.ust.project.siklab.Results.ActivityResultTwo;
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quizNum < 5) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), ActivityQuizTwo.class);
                    ...
                    startActivity(new Intent(getApplicationContext(), ActivityResultTwo.class));
                }
            }
        });
    }
