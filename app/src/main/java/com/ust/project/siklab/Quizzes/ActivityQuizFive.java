...
import com.ust.project.siklab.Results.ActivityResultFive;
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quizNum < 5) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), ActivityQuizFive.class);
                    ...
                    startActivity(new Intent(getApplicationContext(), ActivityResultFive.class));
                }
            }
        });
    }
